...
阶段 0、0.5、Profile family 基础、真实 SDK Agent 核心 probe、P0、P1 和 P2 已完成。`StudySessionController` 与 `/study-recover` 已通过真实 Pi 人工验收；当前进入 P3 用户手动生成学习画像。
